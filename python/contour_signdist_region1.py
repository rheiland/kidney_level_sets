...
x = np.linspace(-900, 200, nvoxels)
y = np.linspace(0, 700, nvoxels)
...
for iy in range(len(y)):
    ...
    # construct test vertical line segment from grid pt to pt outside domain
    yval = y[iy]
    l1_p0[1] = yval
    ...
    for ix in range(len(x)):
        xval = x[ix]
        # if (yval > 400-delta and yval < 400+delta and xval > -100-delta and xval <-100+delta):
        #     print(ix,iy, xval,yval)
        l1_p0[0] = xval  # xvals of vertical line segment
        l1_p1[0] = xval
        ...
        # for idx in range(0,-1):
            ...
            if True:
                ...
                if px0 > px1:
                    ...
                    px1 = l2_p0[0]
                # if ptint[0] > -800 and ptint[0] < 600 and ptint[1] > -600 and ptint[1] < 600:
                # if ptint[0] >= px0 and ptint[0] <= px1 and ptint[1] > -600 and ptint[1] < 700:
                if ptint[0] >= px0 and ptint[0] <= px1 and ptint[1] > yval:
                    ...
                    # if True:
                        # print(intpts)
                        # print(idx,": l1_p0= ",l1_p0," -> l1p1= ",l1_p1)
                        # print(idx,": ptint = ",ptint)
        # print(iy,ix,intpts)
        if True:
